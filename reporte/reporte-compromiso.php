...
$(document).ready(function () {
    ...
    function cargarCompromiso() {
        ...
        $.ajax({
            url: strServicio+"cartera.php?CONSULTA_AJAX=reporteCompromiso",
            ...
            success: function (jsondata) {
                ...
                $.each(jsondata.d, function (i, obj) {
                    ...
                    "<td><a href='../cobranza/gestionar-cuenta.php?cuenta=" + obj.NRO_CUENTA + "'>" + obj.NRO_CUENTA + "</a></td>" +
...
success: function (jsondata) {
    ...
    function obtener_usuarios(){
        $.ajax({
            url: strServicio+"cartera.php?CONSULTA_AJAX=listarUsuariosGestion",
            dataType: 'JSON',
            type: 'POST',
            contentType: "application/json; charset=utf-8",
            success: function (jsondata) {
                //$("#sltProveedor").empty();
                $.each(jsondata.d, function (i, obj) {
                    $("#sltUsuario").append("<option value='" + obj.USU_CODIGO + "'>" + obj.USU_LOGIN + "</option>");
                });
            }
        });
    }
