...
<!--    <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all" rel="stylesheet" type="text/css" />-->
    ...
    <link rel="shortcut icon" href="<?php echo $url_relativa; ?>resource/masterPage/favicon.ico" />
</head>
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
    <form id="form1">
        ...
        <input type="hidden" value='<?php echo $ruta_web; ?>' data-master='<?php echo $user->getUrlMaster(); ?>' id="rutaWeb" />
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                <!-- BEGIN LOGO -->
                <div class="page-logo">
                    <a href="<?php echo $url_relativa; ?>inicio.php">
                        <img src='<?php echo $url_relativa; ?>resource/assets/layouts/layout/img/logo.png' alt="logo" class="logo-default" /> </a>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-default">
                                ...
                                <li class="divider"> </li>
                                <li>
                                    <a href='<?php echo $url_relativa; ?>logout.php'><i class="icon-key"></i> Salir del sistema </a>
                                </li>
                            </ul>
                        </li>
	...
	<script type="text/javascript" src='<?php echo $url_relativa; ?>resource/assets/global/plugins/jquery-migrate-1.2.1.js'></script>
        ...
        <script>
            ...
            function abrir_preload(bloque_id) {
                App.blockUI({
                    message: '<img src="<?php echo $url_relativa; ?>resource/assets/global/img/loading-spinner-default.gif" />  Procesando...',
                    target: '#' + bloque_id,
                    boxed: true
                });
            }
