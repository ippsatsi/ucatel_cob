...
<asp:Content ID="Content2" ContentPlaceHolderID="contenido" runat="server">
    <div class="form-horizontal" role="form" id="div_contenido">
        ...
        <div class="form-group">
            <label for="txtClave" class="col-md-2 control-label">ANEXO</label>
            <div class="col-md-4">
                <input type="text" id="txtAnexo" class="form-control" placeholder="Ej: 4001" maxlength="4"/>
            </div>
        </div>
        <div class="form-group">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-bottom-20">
                            <div class="col-md-3">
                                ...
                                <select id="sltCriterio" class="form-control">
                                    ...
                                    <option value="3">CALL ACTIVOS</option>
                                    <option value="4">CAMPO ACTIVOS</option>
                                    <option value="5">SUPERVISOR ACTIVOS</option>
                                </select>
                            </div>
                            <div class="col-md-3">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btnGuardar").click(function () {
                ...
                usuario.USU_ESTADO_REGISTRO = $("#sltEstado").val() + '|' + $("#txtAnexo").val() ;
        ...
        function editar(codigo) {
            ...
            $.ajax({
                ...
                success: function (jsondata) {
                    ...
                    $("#sltEstado").val(jsondata.d.USU_ESTADO_REGISTRO.substring(0,1));//17.08.18 ADD ANEXO
                    $("#sltRol").val(jsondata.d.USU_ROL);
                    $("#txtAnexo").val(jsondata.d.USU_ESTADO_REGISTRO.substring(2));//17.08.18 ADD ANEXO
                }
            });
        }
