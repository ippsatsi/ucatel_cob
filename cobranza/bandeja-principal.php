...
Final;
$titulo = "BANDEJA DE GESTIONES";//"BANDEJA DE GESTIONES";
...
$script =<<<Final
<script type="text/javascript" src='${url_relativa}resource/js/cobranza/bandeja-principal.js'></script>
<script type="text/javascript" src='${url_relativa}resource/js/verificar_session.js'></script>
<script src="${url_relativa}resource/js/vita/vita.message.js"></script>
