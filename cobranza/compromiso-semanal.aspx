<%@ Page Title="" Language="C#" MasterPageFile="~/resource/masterPage/Template.Master" AutoEventWireup="true" CodeBehind="compromiso-semanal.aspx.cs" Inherits="WEB.cobranza.compromiso_semanal" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var cargarCompromiso = function () {
                ...
                $.ajax({
                    url: strServicio+"indicador.asmx/obtenerCompromisoSemanal",
                    ...
                    success: function (jsondata) {
                        ...
                        $.each(jsondata.d, function (i, obj) {
                            ...
                            "<td><span>" + (i + 1) + "</span></td>" +
                            "<td><a href='gestionar-cuenta.aspx?cuenta=" + obj.NRO_CUENTA + "'>" + obj.NRO_CUENTA + "</a></td>" +
