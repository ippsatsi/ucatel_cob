<%@ Page Title="" Language="C#" MasterPageFile="~/resource/masterPage/Template.Master" AutoEventWireup="true" CodeBehind="registro_archivo.aspx.cs" Inherits="WEB.carga.registro_archivo" %>
...
function cargarSubCarteras() {
    $.ajax({
        ...
        function listarResumenCuentas() {
            $.ajax({
                url: strServicio + "cartera.asmx/listarResumenCuentas",
                dataType: 'JSON',
                type: 'POST',
                contentType: "application/json; charset=utf-8",
                success: function (jsondata) {
