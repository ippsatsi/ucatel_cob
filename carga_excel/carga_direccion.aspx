<%@ Page Title="" Language="C#" MasterPageFile="~/resource/masterPage/Template.Master" AutoEventWireup="true" CodeBehind="carga_direccion.aspx.cs" Inherits="WEB.carga_excel.carga_direccion" %>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i> CARGA DE DIRECCIONES</div>
                    <div class="tools"> </div>
                </div>
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-bottom-20">
                            ...
                            <div class="col-md-3">
                                <label>&nbsp;&nbsp;&nbsp;</label>
                                 <a class="btn blue form-control" href="../resource/carga/excel/FORMATO_DIRECCION.xlsx"><i class="fa fa-file-excel-o"></i> DESCARGAR MODELO</a>
                            </div>      
                        </div>
                    </div>
